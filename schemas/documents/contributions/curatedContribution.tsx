...
export const curatedContribution = {
  ...
  fields: [
    ...
    },
    {
      ...
      title: 'Approved',
      description:
        'Should this contribution go live? Make sure it complies to our code of conduct ;) Left empty when the automatic evaluation was not confident either way, which puts the contribution in the "Pending approval" list.',
      type: 'boolean',
    ...
    },
    {
      ...
      title: 'Spam Rating',
      description:
        'How spammy is this contribution? 0 is not spammy at all, 7 is very spammy. Scored by Jev (TypeSafe) from a set of separate questions about the contribution, combined in code.',
    },
    {
      name: 'approvalReasons',
      title: 'Approval Reasons',
      description:
        'Why was this contribution (not) approved? One entry per signal that fired during the automatic evaluation.',
      type: 'array',
      of: [{ type: 'string' }],
    },
    {
      ...
      title: 'Evaluated by',
      description: 'Which model version produced the rating above.',
      type: 'string',
      readOnly: true,
    },
    {
